pipeline {
    ...
    environment {
        project_name = 'service-php' // 项目名称 每个项目单独设置 需要和docker-compose.yml一致
    ...
    parameters {
        string(name: 'git_url', defaultValue: 'ssh://git@gitlab-ce.k8s.tools.vchangyi.com:32201/project/legend_age/service-api.git', description: '代码库地址')
        gitParameter(
            branch: '',
            branchFilter: '*',
            defaultValue: 'master',
        ...
        string(name: 'wechat_robot_notice_key', defaultValue: '34d3fe46-5926-489c-a1b3-c567c6206a3b', description: '企业微信机器人key')
                ...
                script{
                     ...
                     if (params.run_env == 'prod') {
                         ...
                         sh """
                             ...
                             curl -s -H "Content-Type:application/json" -X POST -d '{"msgtype":"text","text":{"content":"有新的发布申请，请及时处理;build-id:${BUILD_ID}","mentioned_mobile_list":["18710839146" , "@all"]}}' https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=34d3fe46-5926-489c-a1b3-c567c6206a3b
                         """
